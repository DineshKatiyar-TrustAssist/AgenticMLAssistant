...
if api_key:
    ...
    logger.error("To enable the system, create a .env file with: GOOGLE_API_KEY=your_api_key_here")
...
code_execution_agent = Agent(
    ...
    model="gemini-3-pro-preview",
    instruction="""You are a code execution agent. Your job is to execute Python code.
